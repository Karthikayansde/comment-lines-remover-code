...
import 'package:comment_lines_remover/components/Dropdown/Widgets/hint_text.dart';
import 'package:comment_lines_remover/components/Dropdown/Widgets/selection_chip.dart';
import 'package:comment_lines_remover/components/Dropdown/Widgets/single_selected_item.dart';
...
class _MultiSelectDropDownState extends State<MultiSelectDropDown> {
  ...
  Widget _buildChip( item,  chipConfig) {
              ...
              child: Material(
                  ...
                  child: Container(
                    constraints: BoxConstraints.loose(
                        Size(size.width, widget.options.length<5?widget.options.length*40:widget.dropdownHeight)),
                    child: Column(
